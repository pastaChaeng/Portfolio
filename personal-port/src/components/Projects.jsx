  ...
  return (
    ...
    <div id="projects" className='max-w-[1040px] m-auto md:pl-20 p-4 py-16 bg-black/100'>
        ...
        <div className='text-center mb-20 font-semibold'>
         <a class='border-solid border-2 border-sky-950  text-gray-300 font-bold  p-2 rounded-full hover:bg-sky-950 hover:text-zinc-950 mr-4' href='#'>Web Development</a>
         <a class='border-solid border-2 border-sky-950  text-gray-300 font-bold  p-2 rounded-full hover:bg-sky-950 hover:text-zinc-950 mr-4' href='#'>Mobile Development</a>
         <a class='border-solid border-2 border-sky-950  text-gray-300 font-bold  p-2 rounded-full hover:bg-sky-950 hover:text-zinc-950 mr-4' href='#'>User Interface Designs</a>
        </div>
