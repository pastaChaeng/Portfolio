...
import { AiOutlineMenu, AiOutlineHome, AiOutlineProject, AiOutlinePhone, AiOutlineFolderOpen, AiOutlineTrophy, AiOutlineForm } from 'react-icons/ai'
    ...
    <div>
      ...
      { nav ? (
        <div className="fixed w-full h-screen bg-black/90 flex flex-col justify-center items-center z-20">
          ...
          <a href="#resume" className="w-[60%] flex justify-center items-center rounded-full shadow-lg bg-gray-400 shadow-gray-700 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-200">
            <AiOutlineForm size={20} />
            <span className="pl-4">Resume</span>
          </a>
          <a href="#contact" className="w-[60%] flex justify-center items-center rounded-full shadow-lg bg-gray-300 shadow-gray-700 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-200">
